...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST["nome"]) && isset($_POST["descricao"]) && isset($_POST["quantidade"]) && isset($_POST["valor"])) {
        ...
        if (empty($nome) || empty($descricao) || $quantidade < 0 || $valor < 0) {
            ...
            $sql = "INSERT INTO produtos (nome, descricao, quantidade, valor, id_usuario) VALUES (:nome, :descricao, :quantidade, :valor, :id_usuario)";
            $stmt = $db->prepare($sql);
...
<head>
    ...
    <link rel="stylesheet" href="/style/cadastrar.css"> </head>
<body>
